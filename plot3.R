...
legend("topright",legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), rect, trace=TRUE, inset=0, bty ="y", col=c("black", "red", "blue"),lwd=1, pt.cex=1, cex=0.8)
dev.off()

#dev.print(png, file="plot3.png", width=480, height =480, units="px") <- for whatever reason this was messing up my legend
